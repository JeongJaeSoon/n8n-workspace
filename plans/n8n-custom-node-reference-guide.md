...
- [n8n 커스텀 노드 개발 참고서](#n8n-커스텀-노드-개발-참고서)
  - [목차](#목차)
  - [1. 프로젝트 생성](#1-프로젝트-생성)
    - [CLI 사용 (권장)](#cli-사용-권장)
    - [수동 생성 (디렉토리 구조)](#수동-생성-디렉토리-구조)
  ...
  - [5. JsonPlaceholder 노드 (Declarative)](#5-jsonplaceholder-노드-declarative)
    - [Declarative 스타일 핵심 개념](#declarative-스타일-핵심-개념)
  - [6. TextTransformer 노드](#6-texttransformer-노드)
    - [에러 핸들링 패턴](#에러-핸들링-패턴)
  - [7. JsonPlaceholderApi Credentials](#7-jsonplaceholderapi-credentials)
    - [Credentials 핵심 개념](#credentials-핵심-개념)
    - [인증 타입 예시](#인증-타입-예시)
  - [8. 빌드 및 테스트](#8-빌드-및-테스트)
    - [gulpfile.js (아이콘 복사용)](#gulpfilejs-아이콘-복사용)
    - [빌드 명령어](#빌드-명령어)
    - [Docker로 로컬 테스트](#docker로-로컬-테스트)
    - [빠른 테스트 (Volume 마운트)](#빠른-테스트-volume-마운트)
  - [검증 체크리스트](#검증-체크리스트)
  - [참고 자료](#참고-자료)
  - [버전 호환성 요약](#버전-호환성-요약)
